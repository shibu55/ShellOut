$(document).ready(function () {
  ...
  歌やダンスは完全未経験でOK！My Plustarは0からのスタートを応援します少しずつ上達しながら実力を身につけ、デビュー半年を目処にワンマンライブ、やがては全国ツアーを開催できるグループを目指します<br>
  <br>
  ★応募資格★<br>
  ...
  function updateContent() {
    $('.non-recruit-description').html(contents[currentIndex] + '<br/>');
  ...
  const prevButton = addButton('prev-button', '前へ');
  const nextButton = addButton('next-button', '次へ');
  ...
  function appendButtons() {
    $('.non-recruit-description').append(prevButton, nextButton);
